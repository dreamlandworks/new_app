...
import com.satrango.ui.user.user_dashboard.user_offers.UserExpiryOffersAdapter
import com.satrango.ui.user.user_dashboard.user_offers.UserLatestOffersAdapter
import com.satrango.ui.user.user_dashboard.user_offers.UserReferralOffersAdapter
...
class ProviderOffersScreen :
    BaseFragment<ProviderOfferViewModel, FragmentProviderOffersScreenBinding, ProviderOfferRepository>() {

    private lateinit var progressDialog: BeautifulProgressDialog
    private var apis = 0

    override fun getFragmentViewModel(): Class<ProviderOfferViewModel> =
        ProviderOfferViewModel::class.java

    override fun getFragmentBinding(
        layoutInflater: LayoutInflater,
        container: ViewGroup?
    ): FragmentProviderOffersScreenBinding =
        FragmentProviderOffersScreenBinding.inflate(layoutInflater, container, false)
