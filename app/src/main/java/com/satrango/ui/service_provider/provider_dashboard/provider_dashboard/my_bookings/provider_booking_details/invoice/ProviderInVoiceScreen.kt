...
import com.satrango.ui.service_provider.provider_dashboard.provider_dashboard.my_bookings.provider_booking_details.review.ProviderRatingReviewScreen
...
class ProviderInVoiceScreen : AppCompatActivity() {
    ...
    private fun updateInvoice() {
        ...
        val requestBody = ProviderInvoiceReqModel(117, RetrofitBuilder.PROVIDER_KEY)
